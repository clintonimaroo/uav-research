...
class PPONavigationAgent:
    ...
    def update_policy(self):
        ...
        min_length = min(
            ...
            len(self.experience_buffer.actions),
            len(self.experience_buffer.log_probs),
            len(self.experience_buffer.values),
            len(self.experience_buffer.rewards),
            len(self.experience_buffer.terminals)
        )
        
        self.experience_buffer.states = self.experience_buffer.states[:min_length]
        self.experience_buffer.actions = self.experience_buffer.actions[:min_length]
        self.experience_buffer.log_probs = self.experience_buffer.log_probs[:min_length]
        self.experience_buffer.values = self.experience_buffer.values[:min_length]
        self.experience_buffer.rewards = self.experience_buffer.rewards[:min_length]
        self.experience_buffer.terminals = self.experience_buffer.terminals[:min_length]
